...
from langchain_huggingface import HuggingFaceEmbeddings#导入向量模型
...
embeddings = HuggingFaceEmbeddings(model_name="BAAI/bge-small-zh-v1.5")   #初始化向量模型
...
def _make_llm(temperature: float) -> ChatOpenAI:   #初始化大模型
    return ChatOpenAI(
